...
export interface ErrorStateProps {
  ...
  errorType?: 'generic' | 'network' | 'permission' | 'notFound' | 'timeout' | 'toolFailure';
...
> = {
  ...
  network: {
    ...
    defaultDescription: 'Unable to connect to the server. Check your internet connection.',
  },
  permission: {
    icon: 'x-circle',
  ...
  toolFailure: {
    ...
    defaultDescription: 'The AI tool encountered an error while processing your request.',
  },
};
  ...
  return (
    ...
    >
      <div className="w-20 h-20 rounded-full bg-error-100 flex items-center justify-center mb-6">
        <Icon name={config.icon} size="lg" className="text-error-500 w-10 h-10" />
      </div>
