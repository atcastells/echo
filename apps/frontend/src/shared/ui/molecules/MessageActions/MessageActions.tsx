...
const actionConfigs: Record<MessageActionType, ActionConfig> = {
  ...
  thumbsDown: { icon: 'hand-thumb-down', label: 'Bad response', key: 'thumbsDown' },
...
export const MessageActions = ({
  ...
  const availableActions =
    actions ?? (messageType === 'agent' ? defaultAgentActions : defaultUserActions);
  ...
  const getActionState = (action: MessageActionType): 'active' | 'inactive' | null => {
  ...
  <Tooltip content={label} position="top">
    <button
      ...
      className={clsx(
        ...
        state === null && 'text-neutral-500 hover:text-neutral-700 hover:bg-neutral-100',
