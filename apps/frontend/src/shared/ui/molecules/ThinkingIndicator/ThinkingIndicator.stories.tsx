...
export const WithToolUsage: Story = {
  args: {
    ...
    elapsedMs: 3200,
    steps: [
      { id: '1', label: 'Reading resume.pdf', status: 'completed', icon: 'document' },
      { id: '2', label: 'Searching job requirements', status: 'completed', icon: 'magnifying-glass' },
      { id: '3', label: 'Comparing skills', status: 'active', icon: 'sparkles' },
      { id: '4', label: 'Generating recommendations', status: 'pending', icon: 'pencil' },
    ],
  },
};
...
export const ResearchingContext: Story = {
  args: {
    ...
    elapsedMs: 1800,
    steps: [
      { id: '1', label: 'Loading resume.pdf', status: 'completed', icon: 'document' },
      { id: '2', label: 'Extracting work experience', status: 'active', icon: 'magnifying-glass' },
      { id: '3', label: 'Identifying skills', status: 'pending', icon: 'sparkles' },
    ],
  },
};
...
export const ComparingRoles: Story = {
  args: {
    ...
    elapsedMs: 2400,
    steps: [
      { id: '1', label: 'Fetching job description', status: 'completed', icon: 'document' },
      { id: '2', label: 'Matching skills to requirements', status: 'active', icon: 'check-circle' },
      { id: '3', label: 'Calculating match score', status: 'pending', icon: 'star' },
    ],
  },
};
  ...
  render: () => (
    <div className="space-y-4 max-w-md">
      ...
      <ThinkingIndicator
        ...
        steps={[
          { id: '1', label: 'Reading resume.pdf', status: 'completed', icon: 'document' },
          { id: '2', label: 'Reading job_posting.txt', status: 'completed', icon: 'document' },
          { id: '3', label: 'Comparing requirements', status: 'active', icon: 'magnifying-glass' },
          { id: '4', label: 'Generating analysis', status: 'pending', icon: 'pencil' },
        ]}
      />
    </div>
  ),
